...
class Config:
    ...
    MAIL_DEFAULT_SENDER = (
        os.environ.get("MAIL_DEFAULT_SENDER") or "noreply@lamaisonelegante.com"
    )
...
class ProductionConfig(Config):
    ...
    @classmethod
    def validate(cls):
        """Validate production-only requirements when production config is selected."""
...
def get_config(env: str = None) -> Config:
    ...
    validate = getattr(selected_config, "validate", None)
    if validate:
        validate()
